module github.com/fox766/fabric-samples/DistrEnergySys/distributed-energy-system/blockchain/chaincode

go 1.24.3

require (
	github.com/hyperledger/fabric-contract-api-go v1.2.2
	github.com/hyperledger/fabric-samples/asset-transfer-basic/chaincode-go v0.0.0-20250728171042-7f0f4a24fad0
)
